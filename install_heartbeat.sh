...
# Installs the Howzit Heartbeat auto-update system
...
echo "Installing Howzit Heartbeat auto-update system..."

# Copy heartbeat script to system
...
echo "Installation complete! The heartbeat system will:"
echo "  - Check for template updates every 6 minutes"
echo "  - Start automatically on boot"
echo "  - Keep logs in /var/log/howzit_heartbeat.log"
echo ""
echo "To check status: systemctl status howzit-heartbeat.timer"
echo "To view logs: tail -f /var/log/howzit_heartbeat.log"
