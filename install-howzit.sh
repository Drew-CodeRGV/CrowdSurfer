...
cat > "$INSTALL_DIR/config/config.json" << EOL
{
  ...
  "network": {
    ...
    "dhcpRange": "10.0.0.2,10.0.0.100,24h"
  },
  "logging": {
    "level": "info",
    "console": true
...
# Create network configuration script - ETHERNET ONLY VERSION
...
log_message "Enabling and starting dnsmasq..."
...
echo -e "  ${BOLD}DHCP Range:${NC} 10.0.0.2 - 10.0.0.100"
